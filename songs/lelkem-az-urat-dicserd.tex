\beginsong{Lelkem, az Urat dicsérd - !!}[]
  ...
  \beginchorus
    /: \[F]Allelu\[Gm]ja, \[Am]allelu\[B]ja, \[F]allelu\[C]ja, alle\[B]lu\[F]ja! :/ \rep{2}
  \endchorus

  \beginverse\memorize
    \[F]Lelkem, az \[C]Urat di\[F]csérd, \[Gm]áldjad ?a mindenség / az \[C]istenek? \[F]Isten\[C]ét!
  ...
  \beginverse
    ...
    ^Csodálva ^éneke^lem ^félelmes ^tettei ^? ere^jét.
  \endverse
