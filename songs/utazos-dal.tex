...
[
  ...
  \beginverse
    Magas ^erdő, szines ^égbolt hajol ^ösvényem^re,
    Ez a ^szépség új ^háladalt ^ír szi^vem^be.
  \endverse

  \beginchorus
    Ez az \[C/E]út, mit nekem \[F]adtál gyönyö\[Am]rű s néha \[G]fáj,
    De e\[C]lőttem a ke\[F]reszted és \[Am]csilla\[G]god \[C]már.
  \endchorus
  ...
  \beginverse
    ...
    A ve^zérem, uti^társam, uti^célom ^let^tél.
  \endverse
