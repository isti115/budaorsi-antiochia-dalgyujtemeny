...
[
  ...
  \ifchorded
    \beginverse*
      {\nolyrics Előjáték: /: \[Em\⁷] \[C\ᵃᵈᵈ\²] \[G] \[D/F#] :/ \rep{2}}
    \endverse
  \fi

  \beginverse\memorize
    \[Em]Nálad lett \[C]borrá a \[Em]víz, \[C] h\[Em]oltakat \[C]életre \[G]hívsz,
    Nincs más \[Am\⁷]isten, nincsen \[D]más.
  \endverse
  ...
  \beginchorus
    ...
    \ifchorded
      \vspace{0.3cm}
      {\nolyrics Közjáték: /: \[Em\⁷] \[C\ᵃᵈᵈ\²] \[G] \[D/F#] :/ \rep{2}}
      \vspace{0.3cm}
    \fi
  ...
  \refrain{\echo{\[D] Mi állhat elle\[Em]nünk?}}
